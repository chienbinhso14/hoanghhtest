...
title Script Kich hoat Windows va Office Online 6 thang Tu dong gia han Vinh Vien - Copyright (C) All rights reserved.
...
wmic path %spp% where (Description like '%%KMSCLIENT%%') get Name 2>nul | findstr /i Office 1>nul && (set office15=1) || (if not defined win7 echo.&echo %aword% Phat hien San pham Office 2013/2016/2019...)
...
wmic path %spp% where (Description like '%%KMSCLIENT%%') get Name >nul 2>&1 || (echo.&echo Phat hien San pham Office %aword% Khong Ho tro KMS Client...&exit /b)
